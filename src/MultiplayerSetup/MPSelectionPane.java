...
public class MPSelectionPane extends GridPane {
    ...
    private ArrayList<MPSelectionPaneUnitButton> units = new ArrayList<MPSelectionPaneUnitButton>();
    ...
    public void addUnits(){
        for(MPSelectionPaneUnitButton button: units){
            ...
            peeledData = peeledData.replaceAll("\n", ";"); // replace newlines with semicolons for parsing
            {
                ...
                try {
                    ...
                    Unit u = new Unit(imageName, charName, typeName, typeCost, acc, apt, cmp, cpa, def, eva, exp, hp,
                            ...
                            lvlHP, lvlMP, lvlSTR);
                    MPSelectionPaneUnitButton mpSelectionPaneUnitButton = new MPSelectionPaneUnitButton(u, this);
                    units.add(mpSelectionPaneUnitButton);
    ...
    public ArrayList<MPSelectionPaneUnitButton> getUnits() {
        return units;
    }
}
